...
>
> ⚠️ **交付版本号（v0.3.1）与文档版本号（架构设计 v1.2）属不同体系**，勿混用。
...
| 文档 | 说明 |
|---|---|
| `CHANGELOG.md` | 版本变更记录（v0.1.0 六个真 OCR 误报缺陷 / v0.3.0 判定口径变更 + 复核工作台重构 / **v0.3.1 现场反馈 2 处 UI 缺陷 + 判定范围收窄为品牌·型号**） |
