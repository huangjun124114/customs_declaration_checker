...
>
> ⚠️ **交付版本号（v0.1.0）与文档版本号（架构设计 v1.2）属不同体系**，勿混用。
...
| 文档 | 说明 |
|---|---|
| `CHANGELOG.md` | 版本变更记录（含 v0.1.0 修复的 6 个真 OCR 误报缺陷） |
...
| `docs/07_T06逐条判定依据表.md` | 真实样本 18 条逐条 verdict + SOP 依据 |
| `docs/08_交付说明_v0.1.md` | **本版交付说明**（含已知限制） |
